...
SWEP.ViewModel					= "models/weapons/c_csgo_mp7.mdl"
...
SWEP.Primary.Sound				= Sound("Weapon_cmp7.Single")
...
SWEP.SprintPos	 				= { Vector(-0.5,-7.5,-3), Vector(-0.5,-7.5,-3), Vector(-0.5,-7.5,-3) }
SWEP.SprintAng					= { Angle(-12,22,-35), Angle(-6,25,-35), Angle(-12,28,-35) }
